...
3. [storage-and-rag.md](storage-and-rag.md)：理解 Redis、MySQL、ES 的数据边界。
4. [agent-graph.md](agent-graph.md)：理解 Agent、RAG 和工具如何编排。
5. [middleware.md](middleware.md)：最后看横切能力如何包住主链路。
